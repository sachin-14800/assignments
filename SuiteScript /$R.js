function createRecord(){
    ...
    // $$.logExecution("DEBUG",'TestRec',"Hello");
    // var fulfillment=nlapiTransformRecord('salesorder',71026,'itemfulfillment');
    
    // var lineCount=fulfillment.getLineCount('item');
 
    // for (var i = 0; i < lineCount; i++) {
    //     fulfillment.selectLine('item');
    //     fulfillment.setCurrentSublistValue('itemreceive',true);
    //     fulfillment.commitLine('item');
    //   }
    //   var itemreceiveId = nlapiSubmitRecord(fulfillment,true);
